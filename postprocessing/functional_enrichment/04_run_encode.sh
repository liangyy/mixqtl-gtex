...
function_annotation='/gpfs/data/im-lab/nas40t2/yanyul/GitHub/encode_ccre_extractor/output/merged_bed_exclude_unclassified.{tissue}.bed.gz'
...
then
  python functional_enrichment_encode.py \
    ...
    --nefine_cs $nefine_cs \
    --cache_dir $cache_dir \
    --output enrichment/encode_enrichment_$tissue.csv
fi

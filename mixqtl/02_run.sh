...
strong_gene='/scratch/t.cri.yliang/mixQTL-GTExV8/mixfine_old/{tissue}/genes-passed-qc.txt.gz'
mixfine_pip='/scratch/t.cri.yliang/mixQTL-GTExV8/mixfine_old/{tissue}/mixfine.{tissue}_GTEx_eGene.finemap_pip.mixfine.chr{chr_num}.parquet'
nefine_pip='/scratch/t.cri.yliang/mixQTL-GTExV8/mixfine_old/{tissue}/mixfine.{tissue}_GTEx_eGene.finemap_pip.nefine.chr{chr_num}.parquet'
mixfine_cs='/scratch/t.cri.yliang/mixQTL-GTExV8/mixfine_old/{tissue}/mixfine.{tissue}_GTEx_eGene.finemap_cs.mixfine.chr{chr_num}.parquet'
nefine_cs='/scratch/t.cri.yliang/mixQTL-GTExV8/mixfine_old/{tissue}/mixfine.{tissue}_GTEx_eGene.finemap_cs.nefine.chr{chr_num}.parquet'
